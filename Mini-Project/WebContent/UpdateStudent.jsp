...
<html lang="en">
  <head>
    ...
    <title>OES | Student Update</title>
    ...
    <body>
        ...
        <center><h3><pre><font color="Black">Update Student</font></h3></pre></center>
        <div class="jumbotron">
            <form action="EditServlet" method="post">
                <div class="form-group">
                    <label for="id">Student ID:</label>
                      <input type="number" class="form-control" name="id" id="uid">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="pwd">Student Username(Email):</label>
                    ...
                    <center>
                        <input type="submit" value="Update Student"   class="btn btn btn-success">
                        <input type="button" value="Back" class="btn btn btn-danger"  onclick="location.href='StudentRepository.jsp'"><br>
                        <%
