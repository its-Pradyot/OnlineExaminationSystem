...
<html lang="en">
  <head>
    ...
    <title>OES | Student Insert</title>
    ...
    <body>
        ...
        <center><h3><pre><font color="Black">Add a new Student</font></h3></pre></center>
        <div class="jumbotron">
            <form action="StudentInsertServlet" method="post">
                <div class="form-group">
                    ...
                    <center>
                        <input type="submit" value="Add Student"   class="btn btn btn-success">
